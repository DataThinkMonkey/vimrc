...
func! WordProcessorMode() 
  setlocal formatoptions=ant "adds hard paragraph wrapping, make blank line to avoid.
  setlocal noexpandtab 
  set nonumber
  map j gj 
  map k gk
  setlocal spell spelllang=en_us 
"  set thesaurus+=/home/jared/.vim/mthesaur.txt
  set complete+=s
  set formatprg=par
  setlocal wrap 
  setlocal textwidth=80
  setlocal wrapmargin=8 "give right margin space
  setlocal linebreak 
  set foldcolumn=10 "adds a margin on the left
  set columns=100 "adds a margin on the left
  "colors margin line lightgrey
